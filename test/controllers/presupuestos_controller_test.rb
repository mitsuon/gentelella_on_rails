...
class PresupuestosControllerTest < ActionController::TestCase
  ...
  test "should create presupuesto" do
    assert_difference('Presupuesto.count') do
      post :create, presupuesto: { anio: @presupuesto.anio, monto: @presupuesto.monto, semestre: @presupuesto.semestre }
    end
  ...
  test "should update presupuesto" do
    patch :update, id: @presupuesto, presupuesto: { anio: @presupuesto.anio, monto: @presupuesto.monto, semestre: @presupuesto.semestre }
    assert_redirected_to presupuesto_path(assigns(:presupuesto))
  end
